...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.priya.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SOAPWebserviceDemo/services/Calculator";
    ...
    public com.priya.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.priya.CalculatorSoapBindingStub _stub = new com.priya.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.priya.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.priya.CalculatorSoapBindingStub _stub = new com.priya.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://priya.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://priya.com", "Calculator"));
        }
